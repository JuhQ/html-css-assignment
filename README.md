...
* Lighthouse check score is less than 90 -1, less than 70 -2
  ...
  * Update 25.3.2024: If you use `<iframe>` to add Google Maps, Lighthouse will deduct points. That will not affect evaluation. You should however consider just using an image of the map. 
